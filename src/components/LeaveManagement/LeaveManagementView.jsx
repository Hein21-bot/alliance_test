...
class LeaveManagementView extends Component {
    ...
    render() {
        ...
        return (
            <div className="white-bg" style={{ display: 'flex', justifyContent: 'center', height:'500px', overflowY: 'scroll' }}>
                {/* <ToastContainer /> */}
                ...
                <div className="bg-primary" style={{padding: '5px', marginBottom:'20px'}}>
                    ...
                    <div className="form-horizontal white-bg"  style={{paddingLeft:'20px',paddingRight:'20px'}} id="check_form">
                        ...
                        <div className="form-group">
                            <div><label className="col-sm-4">Verify Date<span className="text-danger">*</span></label> </div>
                            <div className="col-sm-8 ">
                                <input type='text' className='form-control' value={this.props.data.verify_date != null ? moment(this.props.data.verify_date).format("YYYY-MM-DD") : "-"} disabled />

                            </div>
                        </div>
                        <div className="form-group">
                            <div><label className="col-sm-4">Approved Date<span className="text-danger">*</span></label> </div>
                            <div className="col-sm-8 ">
                                <input type='text' className='form-control' value={this.props.data.approved_date != null ? moment(this.props.data.approved_date).format("YYYY-MM-DD") : "-"} disabled />
                        ...
                        <div className="form-group">
                            ...
                            <div className="col-sm-8 ">
                                <input type='text' className='form-control' value={moment(this.props.data.application_date).format('YYYY-MM-DD')} disabled />
