...
export default class DesignationTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    showTable(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            one = {
                ...
                remark: obj.remark,
                active: obj.active,
                action: '<button style="margin-right:10px" class="btn btn-primary btn-sm own-btn-edit" id="Edit" ><span id="edit" class="hidden" >' + JSON.stringify(obj) + '</span>&nbsp;Edit</button><button style="margin-right:10px" class="btn btn-primary btn-sm own-btn-edit" id="Delete" ><span id="delete" class="hidden" >' + JSON.stringify(obj) + '</span>&nbsp;Delete</button>',
            }
    ...
    render() {
        return (
            <div>
                <h3 className="col-md-12">Designation Table</h3>
                <table width="99%"
