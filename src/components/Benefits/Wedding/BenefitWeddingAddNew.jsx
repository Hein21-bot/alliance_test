...
import {
    main_url, getCookieData, validate,
    getActionStatus, alertText, havePermission, getWorkFlowStatus, stopSaving, startSaving
...
class BenefitWeddingAddNew extends Component {
    ...
    async setOneBenefit() {
        ...
        var work_flow = await getWorkFlowStatus(one.user_id, this.state.user_id, 'Wedding Benefit', 'Benefit');
        ...
        this.setState({
            ...
            selectedSpouseName: { value: one.spouse_name, label: one.staff_spouse_name },
    ...
    save() {
        ...
        if (validate('check_form') && (this.state.attachment.length > 0 || !Array.isArray(one_benefit))) {
            stopSaving();
            var data = {
            ...
            <div className="container">
                <div className='row'>
                    <form id="check_form">
                            ...
                            <div className="form-group col-md-6">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control input-md"
                                        value={this.state.employee_name} disabled />
                                </div>
                            </div>
                            <div className="form-group col-md-6">
                                ...
                                <div className="col-sm-10">
                                    {
                                        !Array.isArray(one_benefit) && is_main_role ?
                                            <input
                                                ...
                                                // placeholder="Please Provide The Designation"
                                                className="form-control"
                                                value={this.state.spouseCompanyOption === 1 ? 'Yes' : 'No'}
                                                disabled
                                            />
                                            :
                                            <Select
                                        ...
                                        !Array.isArray(one_benefit) && is_main_role ?
                                            ...
                                            this.state.spouseCompanyOption === 1 ?
                                                <Select
                                                    ...
                                                    className='react-select-container  checkValidate'
                                                    classNamePrefix="react-select" value={this.state.selectedSpouseName}
                                                />
                                                :
                                                <input
                                                    type="text"
                        ...
                        <div className="row">
                            <div className="form-group col-md-6">
                                <div><label htmlFor="employee-name" className="col-sm-12">Availabel Amount</label></div>
                                <div className="col-sm-10">
                                    <input type="text" className="form-control input-md"
                                        value={this.state.available_amount} disabled />
                            ...
                            is_main_role ?
                                this.state.doc.length > 0 ?
                                    <div className="row document-main">
                                        ...
                                        <DocumentList title='Wedding Benefit Document' doc={this.state.doc} path="wedding_benefit" />
                                                        ...
                                                        <li className="fileuploader-item file-has-popup file-type-application file-ext-odt">
                                                            <div className="columns">
                                                                <div className="column-title">
                                                                    <a href={`${main_url}wedding_benefit/getCRDocumentData/${data.name}`}
                ...
                <div className="row save-btn">
                    {
                        ...
                        !Array.isArray(one_benefit) && havePermission(this.state.work_flow_status) && this.state.one_benefit.user_id != this.state.user_id ?
                            <ApprovalForm approvalStatus={this.approvalStatus.bind(this)} status={this.state.status} work_flow={this.state.work_flow_status} total_amount={this.state.available_amount} />
                            :
