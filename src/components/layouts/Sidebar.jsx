...
export default class Sidebar extends Component {
  ...
  render() {
    ...
    console.log("hr======>",((pathname == `${'/' + user.user_id}`) ? 'true' : 'false'),this.state.user)
    ...
    // console.log("sidebar permission is =============>", employeeManagement,sidebarPermission)
    return (
      <div>
            ...
            <ul className="nav" id="side-menu">
              ...
              >
                ...
                <ul className="nav nav-second-level collapse">
                  ...
                  {
                    this.state.user.designations_id == 53 || this.state.user.user_id == 640 ? <li
                    className={
              ...
              <li
                ...
                style={{ display: (isHR || this.state.user.user_id == 1110 || this.state.user.user_id == 1467
                  //  || masterData
                   ) ? 'block' : "none" }}
              >
              ...
              <li
                className={
                  this.checkPathName() === "/employee_management" || this.checkPathName() === "/reports" || pathname == "/EmployeeDirectory" || pathname === "/ResignStaffReport" || pathname === "/RegionStaffReport" || pathname === "/BranchStaffReport" || pathname === "/HoStaffReport" || pathname === "/EmployeeReport" || pathname === "/ReportbyServiceYear" || pathname === "/HistoryReport" || pathname === "/FRDReport" || pathname === "/ExtensionReport" || pathname === '/hr_statistic' || pathname === "/RegionWiseStaffReportCount" || pathname === "/report_confirm"
                    ? "active"
                    : " "
                }
              ...
              >
                ...
                <ul className="nav nav-second-level collapse">
                  ...
                  <li className={this.checkPathName() === "/reports" || pathname == "/EmployeeDirectory" || pathname === "/ResignStaffReport" || pathname === '/hr_statistic' || pathname === "/RegionStaffReport" || pathname === "/BranchStaffReport" || pathname === "/HoStaffReport" || pathname === "/EmployeeReport" || pathname === "/ReportbyServiceYear" || pathname === "/HistoryReport" || pathname === "/FRDReport" || pathname === "/ExtensionReport" || pathname === "/RegionWiseStaffReportCount" || pathname === "/report_confirm" ? "active" : " "}
                  ...
                  // style={{ display: (sidebarPermission.length > 0 && sidebarPermission.filter(d => d.permission == "Employee Report") && sidebarPermission.filter(d => d.permission == "Employee Report")[0].access == true ? 'block' : 'none') }}
                      ...
                      <li
                        className={pathname === "/hr_statistic" ? "active" : ""}
                      // style={{ display: (sidebarPermission.length > 0 && sidebarPermission.filter(d => d.permission == "Region Wise Staff Count Report") && sidebarPermission.filter(d => d.permission == "Region Wise Staff Count Report")[0].access == true ? 'block' : 'none') }}

                      >
                        <a href="/hr_statistic">HR Statistic Report</a>
                      </li>
                    </ul>
                  </li>
                </ul>
