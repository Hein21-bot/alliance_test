              ...
              >
                ...
                <ul className="nav nav-second-level collapse">
                  ...
                  <li className={pathname === "/attendance_leave_report" ? "active" : ""}
                    style={{ display: (sidebarPermission.length > 0 && sidebarPermission.filter(d => d.permission == "Leave") && sidebarPermission.filter(d => d.permission == "Leave")[0].access == true ? 'block' : 'none') }}
                  >
