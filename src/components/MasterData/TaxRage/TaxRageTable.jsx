...
export default class TaxRageTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    showTable(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            one = {
                ...
                start_salary_amount: obj.salary_start,
                end_salary_amount: obj.salary_end,
        ...
        var column = [
            ...
            { title: 'Start Salary Amount', data: 'start_salary_amount' },
            { title: 'End Salary Amount', data: 'end_salary_amount' },
            { title: 'Tax Rate', data: 'tax_rate' },
    ...
    render() {
        return (
            <div>
                <h3 className="col-md-12">Tax Rage Table</h3>
                <table width="99%"
