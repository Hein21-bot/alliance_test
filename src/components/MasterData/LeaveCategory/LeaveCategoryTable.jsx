...
export default class LeaveCategoryTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    showTable(data) {
        ...
        var column = [
            ...
            { title: 'Leave Quota', data: 'leave_quota' },
            { title: 'Allow Leave Count', data: 'allow_leave_count' },
            { title: 'Leave Policy Description', data: 'leave_policy' },
    ...
    render() {
        return (
            <div>
                <h3 className="col-md-12">Leave Category Table</h3>
                <table width="99%"
