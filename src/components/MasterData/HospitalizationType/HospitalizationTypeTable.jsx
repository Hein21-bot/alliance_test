...
export default class HospitalizationTypeTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    showTable(data) {
        ...
        var column = [
            { title: 'No', data: 'no' },
            { title: 'Hospitalization Type', data: 'hospitalization_type' },
    ...
    render() {
        return (
            <div>
                <h3 className="col-md-12">Job Title Table</h3>
                <table width="99%"
