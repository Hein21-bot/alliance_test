...
class DepartmentAddNew extends Component {
    constructor(props) {
        super(props);
        this.state = {
            department:"",
...
this.setState({
    ...
    handleSave = () => {
        if (validate('check_form')) {
            ...
            fetch(`${main_url}department/addDepartment`, {
                method: "POST",
                headers: {
    ...
    render() { console.log(this.state.active,this.state.department,this.state.remark);
        return (
