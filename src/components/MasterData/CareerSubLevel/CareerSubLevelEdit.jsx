...
class CareerSubLevelEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: props.data
    ...
    handleSelectorChange = (val, key) => {
        ...
        const value = (level_options.find(v => Number(v.career_level_id) === Number(val.career_level_id))).career_level_id;
        const obj = { ...this.state.data };
        obj[key] = value;
        this.setState({
            data: obj
    ...
    handleSave = () => {
        ...
        if (validate('check_form')) {
            ...
            let status = 0;
            fetch(`${main_url}careerSubLevel/editCareerSubLevel/${Number(data.career_sub_level_id)}`, {
                method: "POST",
                headers: {
                        ...
                        <div className="row">
                            <div className="form-group col-md-12">
                                <div className='col-md-6' style={{ padding: 0 }}>
                                    <div><label htmlFor="career_level_id" className="col-sm-12">Career Level</label></div>
                                    <Select
...
export default CareerSubLevelEdit