...
class LateCheckInReport extends Component {
    constructor(props) {
        super(props);
        this.state = {
            branch:[],
    ...
    _setTableData = (data) => { 
        ...
        return (
           ...
           <h3 className="" style={{paddingLeft:"10px"}}>Late Check-In Report</h3>
    ...
    export default LateCheckInReport;