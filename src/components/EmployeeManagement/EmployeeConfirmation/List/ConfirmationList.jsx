...
class ConfirmationList extends Component {
  ...
  handleCheckBoxChange = async (data) => {
    ...
    const newData = {
      ...
      current_sub_level_service_year : data.current_sub_level_service_year ? data.current_sub_level_service_year  : "-",
      current_level_service_year : data.current_level_service_year ? data.current_level_service_year  : "-",
     ...
     await fetch(main_url + 'confirmation/detailCheckPerson/' + v.branch_id + '/' + v.user_id).then(response => {
      return response.json();
        ...
        const newData = {
          ...
          current_sub_level_service_year : v.current_sub_level_service_year ? v.current_sub_level_service_year  : "-",
          current_level_service_year : v.current_level_service_year ? v.current_level_service_year  : "-",
