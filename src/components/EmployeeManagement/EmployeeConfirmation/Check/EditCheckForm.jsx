...

                    {
                        ...
                        <div className='w-100' style={{ display: 'flex', justifyContent: 'center', padding: 10 }}>
                            <div className='col-lg-6 col-md-10 col-sm-12' style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', }}>
                                ...
                                <div className='col-lg-6 col-md-6 col-sm-6'>
                                    <input type={view ? 'text' : 'date'} placeholder='' required={status == 2 && recommendation =="Confirmation"} name="effectiveDate" value={effectiveDate ? moment(effectiveDate).format('YYYY-MM-DD') : null} onChange={handleEditCheckInputChange} style={{ height: 40, width: 160 }} />
...

{
            ...
            {view ? <div className="row approval-main">
                {
                    !Array.isArray(status_info) ?

                        <div className="margin-top-20">
                            <ApprovalInformation status={status_info} />
                        </div>
                        : ''
                }
            </div> : null}
