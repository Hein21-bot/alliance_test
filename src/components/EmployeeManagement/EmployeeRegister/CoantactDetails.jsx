...
const ContactDetails = props => {
    ...
    const guarantorNRC = guaFullNRC ? guaFullNRC
    // guaFullNRC.split(" ")[0] + '/' + guaFullNRC.split(" ")[1] + '(N)' + guaFullNRC.split(" ")[2] 
    : `${selected_gran_NRC_Id ? selected_gran_NRC_Id.label : ''} ${selected_gran_DistrictCode ? '/' + selected_gran_DistrictCode.label : ''} ${gran_nrc_number ? '(N)' + gran_nrc_number : ''}`
    return (
