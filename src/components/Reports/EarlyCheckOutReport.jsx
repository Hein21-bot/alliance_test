...
class EarlyCheckOutReport extends Component {
    ...
    // handleSearchData=()=>{
    //   console.log(">>>>>",this.state.branchId,this.state.departmentId,this.state.regionId,this.state.designationId,this.state.to_date,this.state.from_date)
    //   }
    ...
    _setTableData = (data) => {
        ...
        var column = [
            ...
            { title: "Early Check Out", data: "check_out" },
