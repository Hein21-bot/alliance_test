...
class LateReport extends Component {
    ...
    _setTableData = (data) => {
        ...
        var column = [
            ...
            { title: "Late Check In", data: "late_checkin" },
            { title: "Early Check Out", data: "early_checkout" },
            { title: "Incomplete", data: "incomplete" },
            { title: "Missing Attendance", data: "missing_attendance" },
            { title: "Absence", data: "absence" },
