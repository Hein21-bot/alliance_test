...
import {
    ...
    stopSaving, startSaving, calculationDate
    ...
    changeText = (e) => {
        ...
        if (name === 'noOfParticipant') {
            ...
            for (var i = 0; i < detail.length; i++) {
                detail[i].amount = detail[i].costFee * data.noOfParticipant *
                    ...
                    this.state.isAddNew ? (
                        <div>
                            ...
                            <div className="row" style={{ marginLeft: 0 }}>
                                ...
                                <div id="check_form">
                                    <h4 style={{ marginTop: 20 }}>Actual Information</h4>
                                ...
                                <div className="col-md-12" id="expense_check_form">
                                    <div className="ibox float-e-margins row">
                                        <div className="ibox-content p-md col-md-12" style={{ float: 'left', }}>
                                            <div className="col-md-3">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="col-md-12">
                                                    ...
                                                    <div className="col-md-4 boldFt" > Grand Total : {grandTotal}</div>
                                                    {/* <div className="col-md-4"> Average Cost Per Participant : {avgCostPerPerson.toFixed(2)}</div> */}
                                                    <div className="col-md-4 boldFt"> Average Cost Per Participant : {(grandTotal / this.state.data.noOfParticipant).toFixed(2)}</div>
                                                    <div className="col-md-4 boldFt"> Advanced Settle Amount : {(grandTotal - this.state.data.advancedGrandTotal).toFixed(2)}</div>
