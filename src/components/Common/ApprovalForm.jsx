                        ...
                        this.haveAllPermission(permission) ?
                            <div className="float-right m-b-10" >
                                ...
                                {permission.check_by > 0 ?
                                    <button className="btn btn-primary m-r-10" onClick={() => this.props.approvalStatus('checked', this.state.comment)} disabled={this.props.status === 0 ? false : this.props.status === 5 ? true : true}>
                                ...
                                {permission.approve_by > 0 ?
                                    <button className="btn btn_approved" onClick={() => this.props.approvalStatus('approved', this.state.comment)} disabled={this.props.status === 2 && this.checkLimitAmount() ? false : this.props.status === 5 ? true : true}>
                                        <i className="fa fa-check"></i> Approve </button>
                                    : ''}
                                < button className="btn btn_reject"
                                    disabled={this.checkRejectState()}
